...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="test-demo-gds1")
    bq_project = Variable.get("bq_project", default_var="analog-octagon-469617-c1")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "1065554676904-compute@developer.gserviceaccount.com",
